...
def format_for_claude(data: dict) -> str:
    ...
    lines.append("1. Whether this EA should be used (GO/NO-GO decision)")
    lines.append("2. Key concerns or red flags")
    lines.append("3. If viable, which parameter set to use and why")
    lines.append("4. Specific improvements to investigate")
